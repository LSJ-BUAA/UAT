...
- For Learning Hybrid Precoding
  - Generate Channel Datasets
    - Use `hybrid precoding\channels\matCode\mainGenChannel.m` to generate datasets with *QuaDRiGa*. The different channel distributions are modified from `foundation\quadriga_TR38901_single_cell_channel.m`, which includes detailed annotations.
